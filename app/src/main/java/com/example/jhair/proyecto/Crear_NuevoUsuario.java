...
public class Crear_NuevoUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crear__nuevo_usuario);
        initComponents();
    }
    ...
    private void initComponents(){
        ...
        regresar.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Crear_NuevoUsuario.this,MainActivity.class);
        ...
        registrarte.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(usuario.getText().toString().equals("")||contra.getText().toString().equals("")||
                    ...
                    Toast.makeText(Crear_NuevoUsuario.this,"Debe llenar todos los campos",Toast.LENGTH_LONG).show();

                }else {
                    if(Validaciones.comprobarUsuario(usuario.getText().toString())){
                        Toast.makeText(Crear_NuevoUsuario.this,"Usuario ya en uso,escriba otro",Toast.LENGTH_LONG).show();
                        ...
                        switch (tipo){
                            case "Normal":
                                ...
                                Toast.makeText(Crear_NuevoUsuario.this,"A creado un Usuario Normal",Toast.LENGTH_LONG).show();
                            ...
                            case "Limitado":
                                ...
                                Toast.makeText(Crear_NuevoUsuario.this,"A creado un usuario Limitado",Toast.LENGTH_LONG).show();

                                break;

                        }
                        Intent intent = new Intent(Crear_NuevoUsuario.this,administrarusuarios.class);
                        startActivity(intent);
                        finish();
